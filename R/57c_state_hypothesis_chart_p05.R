...
p <- ggplot(scan, aes(r, label, color = category)) +
  ...
  labs(
    ...
    subtitle = "Pearson r (95% CI), each outcome vs. arrests per 100k residents. Filled dot = p < 0.05. DC excluded throughout. n = 43-50 states.",
...
ggsave("graphics/fig_state_hypothesis_scan_p05.png", p, width = 12, height = 8.7, dpi = 200)
